				...
				<td style="word-break: break-word; vertical-align: top;" valign="top">
					<div style="background-color:transparent;">
						<div class="block-grid"
							style="min-width: 320px; max-width: 605px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; Margin: 0 auto; background-color: transparent;">
							<div
					...
					<div style="background-color:#ebe8e8;">
						<div class="block-grid"
							style="min-width: 320px; max-width: 605px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; Margin: 0 auto; background-color: #ffffff;">
								...
								<div class="col num12"
									...
									<div class="col_cont" style="width:100% !important;">
										<div
											...
											<div
												style="color:#000000;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:2;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
												<div
													style="line-height: 2; font-size: 12px; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; color: #000000; mso-line-height-alt: 24px;">
													<p
													...
													<p
														style="text-align: left; line-height: 2; word-break: break-word; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; mso-line-height-alt: 24px; margin: 0;">
														<strong>Kính gửi {{ $firstName .' ' . $lastName}},</strong></p>
													<p
														style="text-align: left; line-height: 2; word-break: break-word; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; mso-line-height-alt: 24px; margin: 0;">
														 </p>
													<p
													...
													<p
														style="text-align: left; line-height: 2; word-break: break-word; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; mso-line-height-alt: 24px; margin: 0;">
														Xin vui lòng nhấp chuột vào bên dưới để cài đặt lại mật khẩu:</p>
													<p
														style="text-align: left; line-height: 2; word-break: break-word; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; mso-line-height-alt: 24px; margin: 0;">
														<a href="{{ $url}}"
															rel="noopener" style="color: #f61e1e;" target="_blank">{{ $url }}</a></p>
													<p
														style="text-align: left; line-height: 2; word-break: break-word; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; mso-line-height-alt: 24px; margin: 0;">
														 </p>
													<p
														...
														giờ và luôn luôn như vậy.</p>
													<p
														style="text-align: left; line-height: 2; word-break: break-word; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; mso-line-height-alt: 24px; margin: 0;">
														Như bạn có thể đã biết, chúng tôi là một công ty môi giới cho
														phép mọi người mua và bán các cặp tiền, cổ phiếu, chỉ số, quỹ,
														hàng hóa thông qua các ứng dụng giao dịch cho máy tính để bàn,
														web và di động.</p>
													<p
														style="text-align: left; line-height: 2; word-break: break-word; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; mso-line-height-alt: 24px; margin: 0;">
														 </p>
													<p
														...
														cần giao dịch một mình và các nhà quản lý nhận thêm thu nhập
														thông qua quản lý hiệu quả các khoản đầu tư.</p>
													<p
														style="text-align: left; line-height: 2; word-break: break-word; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; mso-line-height-alt: 24px; margin: 0;">
														 </p>
													<p
													...
													<p
														style="text-align: left; line-height: 2; word-break: break-word; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; mso-line-height-alt: 24px; margin: 0;">
														Chúng tôi khuyến khích bạn liên hệ với chúng tôi bất cứ lúc nào
														với mọi câu hỏi, nhận xét và phản hồi của bạn.</p>
													<p
														style="text-align: left; line-height: 2; word-break: break-word; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; mso-line-height-alt: 24px; margin: 0;">
														 </p>
													<p
														...
														Bạn có thể liên lạc với chúng tôi trong giờ làm việc thông
														thường theo các cách sau:</p>
													<p
														style="line-height: 2; word-break: break-word; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; mso-line-height-alt: 24px; margin: 0;">
												...
												<a
													...
													target="_blank"><span
														style="padding-left:55px;padding-right:55px;font-size:12px;display:inline-block;"><span
															style="line-height: 32px; word-break: break-word;">Go to
															website</span></span></a>
											</div>
										</div>
									</div>
					...
					<div style="background-color:#ebe8e8;">
						<div class="block-grid"
							style="min-width: 320px; max-width: 605px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; Margin: 0 auto; background-color: #ebe8e8;">
							<div style="border-collapse: collapse;display: table;width: 100%;background-color:#ebe8e8;">
								<div class="col num12"
									style="min-width: 320px; max-width: 605px; display: table-cell; vertical-align: top; width: 605px;">
									<div class="col_cont" style="width:100% !important;">
										<div
											...
											<div
												style="color:#7d7171;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:1.5;padding-top:20px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
												<div
					...
					<div style="background-color:#f8fbfb;">
						<div class="block-grid"
							style="min-width: 320px; max-width: 605px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; Margin: 0 auto; background-color: transparent;">
							<div
								style="border-collapse: collapse;display: table;width: 100%;background-color:transparent;">
						...
						<div class="block-grid"
							...
							<div
								...
								<div class="col num12"
									...
									<div class="col_cont" style="width:100% !important;">
										<div
											style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:50px; padding-right: 0px; padding-left: 0px;">
											<div></div>
										</div>
									</div>
								</div>
						...
						<div class="block-grid"
							...
							<div
								...
								<div class="col num12"
									...
									<div class="col_cont" style="width:100% !important;">
										<div
											style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:30px; padding-bottom:35px; padding-right: 0px; padding-left: 0px;">
											<table border="0" cellpadding="0" cellspacing="0" class="divider"
												role="presentation"
												style="table-layout: fixed; vertical-align: top; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; min-width: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;"
												valign="top" width="100%">
